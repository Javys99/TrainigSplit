                    ...
                    <form action="{{ route('register') }}" method="POST" class="f1">
                        ...
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" value="{{ old('name') }}" name="name" placeholder="Nombre"
                                    class="f1-first-name form-control" id="name">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" value="{{ old('age') }}" name="age" placeholder="Edad"
                                    class="f1-last-name form-control" id="age">
                            </div>
                            <div class="form-group">
                                <label class="sr-only" for="weight">Peso</label>
                                <input type="number" value="{{ old('weight') }}" name="weight" placeholder="Peso"
                                    class="f1-last-name form-control" id="last_name">
                            </div>
                            <div class="form-group">
                                <label class="sr-only" for="last_name">Altura</label>
                                <input type="number" value="{{ old('height') }}" name="height" placeholder="Altura"
                                    class="f1-last-name form-control" id="last_name">
                            </div>
                            <div class="form-group">
                                <label class="sr-only" for="gender">Genero</label>
                                <select id="gender" value="{{ old('gender') }}" class="f1-last-name form-control"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" value="{{ old('phone_number') }}" name="phone_number"
                                    placeholder="Numero de telefono" class="f1-last-name form-control"
                                    id="phone_number">
                            </div>
                        ...
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" value="{{ old('email') }}" name="email"
                                    placeholder="Correo" class="f1-email form-control" id="f1-email">
                            </div>
                            <div class="form-group">
                                <label class="sr-only" for="f1-password">Contraseña</label>
                                <input type="password" value="{{ old('password') }}" name="password"
                                    placeholder="Contraseña" class="f1-password form-control" id="f1-password">
                            </div>
                            <div class="form-group">
                        ...
                        <fieldset>
                            <h4>Reseña brevemente tus actividades cotidianas como a que hora te levantas, horarios de
                                tus comidas, trabajas y duermes,
                                asi como alimentos que no puedas consumir/disgusten o te provoquen alergia y por ultimo
                                si tienes algun padecimiento, lesion,
                                operacion o enfermedad cronico degenerativa.
                            </h4>
                            <div class="form-group">
                                <label class="sr-only" for="f1-about-yourself">Sobre ti</label>
                                <textarea name="activity_details" value="{{ old('activity_details') }}"
                                    placeholder="Cuentanos un poco de tu dia a dia" class="f1-about-yourself form-control" id="activity_details"></textarea>
                            </div>
                            <div class="f1-buttons">
                                <button type="button" class="btn btn-previous">Regresar</button>
